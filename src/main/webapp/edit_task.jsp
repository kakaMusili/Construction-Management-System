...
<%
    ...
    if(n==null)
    {
        ...
        task=(Task) request.getAttribute("editTask");
            ...
            <form action="taskServlet" class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="taskName"  value="<%=task.getTaskName()%>" required >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4"> Description :</label>
                        <div class="col-md-6">
                            <textarea class="form-control" name="taskDescription"  rows="3" value="<%=task.getTaskDescription()%>" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control" id="start" name="expectedStartDate" value="<%out.write(formatter.format(date));%>"
                                   min="<%=task.getMilestone().getExpectedStartDate()%>" max="2030-12-31" /> </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control" id="starter" name="expectedEndDate" value="<%out.write(formatter.format(date));%>"
                                   min="<%=task.getMilestone().getProject().getExpectedStartDate()%>" max="2030-12-31" /> </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control" id="actualstart" name="actualStartDate"
                                   ...
                                   min="<%=task.getMilestone().getProject().getActualStartDate()%>" max="2030-12-31"/></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="submit" name="task" class="btn btn-primary" value="editTask">
                    </div>
                </fieldset>
            </form>
