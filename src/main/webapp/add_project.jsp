            ...
            <form action="projectServlet" class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <textarea class="form-control" name="projectDescription"  rows="3" placeholder="type project description ... " required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4"> Country :</label>
                        <div class="col-md-6">
                            <select class="form-control" name="projectCountry">
                    ...
                    <div class="col-md-4">
                        <input type="submit" name="project" class="btn btn-primary" value="addProject">
                    </div>
                </fieldset>
            </form>
