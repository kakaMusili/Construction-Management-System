...
<%
   ...
   Milestone milestone = null;
    ...
    if(n==null)
    {
        ...
        milestone=(Milestone) request.getAttribute("editMilestone");
            ...
            <form action="milestoneServlet" class="form-horizontal" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="milestoneName"  value="<%=milestone.getMilestoneName()%>" required >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4"> Description :</label>
                        <div class="col-md-6">
                            <textarea class="form-control" name="milestoneDescription"  rows="3" value="<%=milestone.getMilestoneDescription()%>" required></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control" id="start" name="expectedStartDate" value="<%out.write(formatter.format(date));%>"
                                   min="<%=milestone.getProject().getExpectedStartDate()%>" max="2030-12-31" /> </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" class="form-control" id="actualstart" name="actualStartDate"
                                   ...
                                   min="<%=milestone.getProject().getActualStartDate()%>" max="2030-12-31"/></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="submit" name="milestone" class="btn btn-primary" value="editMilestone">
                    </div>
                </fieldset>
            </form>
