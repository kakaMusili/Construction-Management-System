                ...
                <div class="col-md-6 col-md-offset-4 well">
                    <form class="form-signin" action="roleServlet" method="post">
                        ...
                        <div class="form-label-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="inputEmail" name="role" class="form-control" placeholder="enter role eg. supervisor" required autofocus>
                            </div>
                        ...
                        <input class="btn btn-lg btn-primary btn-block" name="roleObject" type="submit" value="addRole">
                    </form>
                </div>
            </div>
